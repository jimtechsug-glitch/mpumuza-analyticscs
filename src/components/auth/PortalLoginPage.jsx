  ...
  return (
    <div className="min-h-screen bg-slate-50 text-slate-900 flex flex-col font-sans selection:bg-amber-400 selection:text-slate-950 relative overflow-x-hidden">
      ...
      <div className="absolute inset-0 pointer-events-none overflow-hidden">
        <div className="absolute -top-32 -left-32 w-[500px] h-[500px] bg-amber-400/10 rounded-full blur-3xl" />
        <div className="absolute bottom-0 -right-32 w-[500px] h-[500px] bg-sky-400/10 rounded-full blur-3xl" />
      </div>
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center space-x-3">
            ...
            <div className="flex items-center space-x-2.5">
              <div className="h-9 w-9 rounded-xl bg-gradient-to-br from-amber-500 to-amber-600 flex items-center justify-center text-white shadow-md shadow-amber-500/20">
      ...
      <main className="flex-1 flex items-center justify-center p-4 sm:p-6 lg:p-8 relative z-10">
        <div className="w-full max-w-2xl bg-white border border-slate-200 rounded-3xl p-6 sm:p-10 shadow-xl text-left space-y-6">
          ...
          <div className="text-center space-y-2 pb-2">
            <div className="inline-flex items-center space-x-2 bg-amber-50 border border-amber-200 text-amber-700 text-xs px-3.5 py-1 rounded-full font-bold mb-1">
            ...
            <div className="space-y-3 pt-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                ...
                <button
                  ...
                  className="p-3.5 bg-slate-50 border border-slate-200 hover:border-amber-500 rounded-2xl text-left transition-all group flex items-center justify-between shadow-xs hover:bg-amber-50/40"
                >
                  <div className="min-w-0 pr-2">
                    <div className="font-bold text-slate-900 group-hover:text-amber-800 flex items-center space-x-2 text-xs">
            ...
            <form onSubmit={handleStaffSubmit} className="space-y-4 pt-1">
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 rounded-2xl px-4 py-3 text-sm text-slate-900 focus:outline-none focus:border-amber-500 transition-colors placeholder:text-slate-400"
                />
              </div>
              ...
              <div>
                ...
                <div className="relative">
                  <input
                    ...
                    className="w-full bg-white border border-slate-300 rounded-2xl px-4 py-3 text-sm text-slate-900 focus:outline-none focus:border-amber-500 transition-colors placeholder:text-slate-400 pr-11"
                  />
                  <button
                    type="button"
              ...
              <div className="flex items-center justify-between text-xs text-slate-500 pt-1">
                <span className="text-[11px] text-amber-700 font-semibold">Demo: admin123 / teacher123</span>
                <span className="text-[11px]">256-bit Encrypted Session</span>
              </div>

              <button
                type="submit"
                className="w-full py-3.5 bg-gradient-to-r from-amber-500 to-amber-600 hover:from-amber-400 hover:to-amber-500 text-white font-bold rounded-2xl shadow-md transition-all text-sm active:scale-98"
              >
          ...
          {activeTab === 'parent' && (
            <form onSubmit={handleParentSubmit} className="space-y-4 pt-1">
              <div className="bg-sky-50 border border-sky-200 p-3.5 rounded-2xl text-xs text-sky-900">
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 rounded-2xl px-4 py-3 text-sm text-slate-900 focus:outline-none focus:border-amber-500 transition-colors font-mono uppercase"
                />
              </div>
              ...
              <div>
                ...
                <input
                  ...
                  className="w-full bg-white border border-slate-300 rounded-2xl px-4 py-3 text-sm text-slate-900 focus:outline-none focus:border-amber-500 transition-colors font-mono"
                />
              </div>
