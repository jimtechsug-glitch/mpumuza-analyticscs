          ...
          {activeTab === 'quick' && (
            <div className="space-y-3 pt-1">
              ...
              <div className="grid grid-cols-1 sm:grid-cols-2 gap-2.5">
                ...
                {/* 1. Secondary School Admin (Kitende) */}
                <button
                  type="button"
                ...
                >
                  <div className="min-w-0 pr-2">
                    <div className="font-bold text-slate-900 group-hover:text-emerald-800 flex items-center space-x-2 text-xs">
                      ...
                      <span className="truncate">Secondary Admin (O &amp; A Level)</span>
                    </div>
                ...
                {/* 2. Primary School Admin (Kampala Parents) */}
                <button
                  type="button"
                ...
                {/* 3. Secondary School Admin (Mengo SS) */}
                <button
                  type="button"
                ...
                >
                  <div className="min-w-0 pr-2">
                    <div className="font-bold text-slate-900 group-hover:text-emerald-800 flex items-center space-x-2 text-xs">
                      ...
                      <span className="truncate">Mengo SS Admin</span>
                    </div>
                    <span className="text-[10px] text-slate-500 block truncate mt-0.5">Mengo Senior School (UACE)</span>
                  </div>
                  <ArrowRight className="w-4 h-4 text-slate-400 group-hover:text-emerald-600 transition-transform group-hover:translate-x-1 shrink-0" />
                </button>
